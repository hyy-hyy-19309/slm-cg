...
# ADD
CenterNumber = [(i + 1) * NT / 4 for i in range(2)]
r0List = []
for xi in CenterNumber:
    for yi in CenterNumber:
        r0List.append((xi, yi))

#   ===   Target Amplitude   ==============================================
Ta, Tap = slm.target_lg(n=NT, r0List=[r0], w=sigma, l=l, A=1.0, save_param=True)
...
#   ===   Weighting cg   ==================================================
Weighting, Weightingp = slm.gaussian_top_round(n=NT, r0List=[r0], d=d2 + sigma, sigma=2, A=1.0, save_param=True)
